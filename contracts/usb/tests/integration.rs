use usb_plugin::{
    ...
    msg::{
        ConfigResponse, CountResponse, UsbExecuteMsgFns, UsbInstantiateMsg, UsbQueryMsgFns,
    },
...
struct TestEnv<Env: CwEnv> {
    ...
    app: Application<Env, UsbInterface<Env>>,
}
...
impl TestEnv<MockBech32> {
    ...
    fn setup() -> anyhow::Result<TestEnv<MockBech32>> {
        ...
        let app = publisher
            .account()
            .install_app::<UsbInterface<_>>(&UsbInstantiateMsg { count: 0 }, &[])?;
